...
public class TryYourLuck {
    ...
    ArrayList<CardOfChance> cardsOfChance;
    ...
    public TryYourLuck() {
        ...
        CardOfChance card4 = new CardOfChance("Fængsel#4", "FÆNGSEL!", "Du er blevet saget for at cykle imod færdselsretningen, og bliver derfor sat i fængsel!");
        CardOfChance card5 = new CardOfChance("Fængsel#5", "FÆNGSEL!", "Du er blevet saget for at cykle imod færdselsretningen, og bliver derfor sat i fængsel!");
// card...
