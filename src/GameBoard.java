...
public class GameBoard {
    ...
    public GameBoard() {
        ...
        //blue
        HousePlot Roedovrevej = new HousePlot("Rødovrevej", HousePlot.HousePlotType.BLUE, 1200, 50, 1000, 600);
   ...
   // public GameField(int pos, String type, String fieldName, TryYourLuck tryYourLuck)
        ...
        gameFields.add(new GameField(1, GameField.GameFieldType.HOUSEFIELD, "Rødovrevej", Roedovrevej));
