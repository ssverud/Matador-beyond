...
public class GameBoard {
    ...
    public GameBoard() {
        ...
        gameFields.add(new GameField(2, GameField.GameFieldType.HOUSEFIELD, "Rødovrevej"));
        gameFields.add(new GameField(3,GameField.GameFieldType.CHANCEFIELD, "Prøv Lykken"));
        gameFields.add(new GameField(4,GameField.GameFieldType.HOUSEFIELD, "Hvidovrevej"));
        gameFields.add(new GameField(5,GameField.GameFieldType.TAXFIELD, "Betal indkomst skat"));
        gameFields.add(new GameField(6,GameField.GameFieldType.FERRYFIELD, "SFL-Færgene"));
        gameFields.add(new GameField(7,GameField.GameFieldType.HOUSEFIELD, "Roskildevej"));
        gameFields.add(new GameField(8,GameField.GameFieldType.CHANCEFIELD, "Prøv Lykken"));
        gameFields.add(new GameField(9,GameField.GameFieldType.HOUSEFIELD, "Valby Langgade"));
        gameFields.add(new GameField(10,GameField.GameFieldType.HOUSEFIELD, "Allégade"));

        
        gameFields.add(new GameField(11,GameField.GameFieldType.VISITPRISON, "Besøg i fængsel"));
        gameFields.add(new GameField(12,GameField.GameFieldType.HOUSEFIELD, "Frederiksberg Alle"));
        gameFields.add(new GameField(13,GameField.GameFieldType.BREWERYFIELD, "Tuborg"));
        gameFields.add(new GameField(14,GameField.GameFieldType.HOUSEFIELD, "Bülowsvej"));
        gameFields.add(new GameField(15,GameField.GameFieldType.HOUSEFIELD, "Gammel Kongevej"));
        gameFields.add(new GameField(16,GameField.GameFieldType.FERRYFIELD, "DSB-Rederierne: Kalundborg-Århus"));
        gameFields.add(new GameField(17,GameField.GameFieldType.HOUSEFIELD, "Bernstorffsvej"));
        gameFields.add(new GameField(18,GameField.GameFieldType.CHANCEFIELD, "Prøv Lykken"));
        gameFields.add(new GameField(19,GameField.GameFieldType.HOUSEFIELD, "Hellerupvej"));
        gameFields.add(new GameField(20,GameField.GameFieldType.HOUSEFIELD, "Strandvej"));


        gameFields.add(new GameField(21,GameField.GameFieldType.PARKINGFIELD, "Parkering"));
        gameFields.add(new GameField(22,GameField.GameFieldType.HOUSEFIELD, "Trianglen"));
        gameFields.add(new GameField(23,GameField.GameFieldType.CHANCEFIELD, "Prøv Lykken"));
        gameFields.add(new GameField(24,GameField.GameFieldType.HOUSEFIELD, "Østerbrogade"));
        gameFields.add(new GameField(25,GameField.GameFieldType.HOUSEFIELD, "Grønningen"));
        gameFields.add(new GameField(26,GameField.GameFieldType.FERRYFIELD, "DFDS-Seaways"));
        gameFields.add(new GameField(27,GameField.GameFieldType.HOUSEFIELD, "Bredgade"));
        gameFields.add(new GameField(28,GameField.GameFieldType.HOUSEFIELD, "Kongens Nytorv"));
        gameFields.add(new GameField(29,GameField.GameFieldType.BREWERYFIELD, "Coca cola"));
        gameFields.add(new GameField(30,GameField.GameFieldType.HOUSEFIELD, "Østergade"));


        gameFields.add(new GameField(31,GameField.GameFieldType.PRISONFIELD, "De fængsles"));
        gameFields.add(new GameField(32,GameField.GameFieldType.HOUSEFIELD, "Amagertorv"));
        gameFields.add(new GameField(33,GameField.GameFieldType.HOUSEFIELD, "Vimmelskaftet"));
        gameFields.add(new GameField(34,GameField.GameFieldType.CHANCEFIELD, "Prøv Lykken"));
        gameFields.add(new GameField(35,GameField.GameFieldType.HOUSEFIELD, "Nygade"));
        ...
        gameFields.add(new GameField(38,GameField.GameFieldType.HOUSEFIELD, "Frederiksborggade"));
        gameFields.add(new GameField(39,GameField.GameFieldType.TAXFIELD, "Ekstraordinær statsskat"));
        gameFields.add(new GameField(40,GameField.GameFieldType.HOUSEFIELD, "Rådhuspladsen"));
